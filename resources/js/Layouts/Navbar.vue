            ...
            <div class="w-full  px-6 py-2 bg-gray-100 border-b flex items-center justify-between">
              ...
              <div class="flex">
                ...
                <div class="inline-block lg:hidden items-center mr-4">
                  <button class="hover:text-blue-500 hover:border-white focus:outline-hidden navbar-burger" @click="$emit('toggleSidebar')">
                ...
                <!-- <div class="relative text-gray-600">
                  <input type="search" name="serch" placeholder="Search products..." class="bg-white h-10 w-full xl:w-64 px-5 rounded-lg border text-sm focus:outline-hidden">
