       ...
       <ModalUpToYou :isModalOpen="open_news" modalSize="large">
        ...
        <template v-slot:body>
            <div class="text-gray-900 text-xs font-medium ">
                ...
                <li >กันยายน 2569 ปรับปรุงระบบตามคำร้องขอของผู้ใช้งาน (Change Request) ขอให้แก้ไขการเก็บข้อมูลราคาวัสดุ จาก 8 รวมทศนิยม 2 หลัก แก้ไขเป็น 10 หลัก รวมทศนิยม 2 หลัก</li>
