       ...
       <ModalUpToYou :isModalOpen="open_news" modalSize="large">
        ...
        <template v-slot:body>
            <div class="text-gray-900 text-xs font-medium ">
                ...
                <li >สิงหาคม 2568 ปรับปรุงระบบตามคำร้องขอของผู้ใช้งาน (Change Request) ขอให้เพิ่มแสดงจำนวนวันของสินค้าคงคลัง</li>
                ...
                <li >กรกฎาคม 2569 ปรับปรุงเวอร์ชัน Laravel Framework จากเวอร์ชัน 12 to 13 ,Inertia 2 to 3 , Tailwind 3 to 4 และ Library ต่างๆ ที่เรียกใช้งาน  เพื่อความปลอดภัยของระบบสารสนเทศ</li>
                <li >กันยายน 2569 ปรับปรุงระบบตามคำร้องขอของผู้ใช้งาน (Change Request) ขอให้แก้ไขการเก็บข้อมูลราคาวัสดุ จาก 8 รวมทศนิยม 2 หลัก แก้ไขเป็น 10 หลัก รวมทศนิยม 2 หลัก และจัดลำดับการเรียงข้อมูลให้รายการวัสดุที่จำนวนคงเหลือเป็น 0 ลงไปอยู่ท้าย จึงแก้ไขโดยเรียงจากวันที่รับเข้าใหม่ที่สุดขึ้นมาก่อน แล้วจึงเรียงตามจำนวนคงเหลือมากที่สุด</li>
