        ...
        <div class="flex flex-col  mb-2 text-md font-bold text-gray-900 ">
             <div class="m-2" >
                ...
                <select name="" id="" v-model="form.stock_selected"
                    class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-2 py-4 pr-6 rounded shadow leading-tight focus:outline-none focus:shadow-outline" >
