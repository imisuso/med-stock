<template>
    <AppLayout>
        ...
        <div class=" w-full p-4 mt-2  justify-center bg-red-100">
            ...
            <p >1.ตรวจสอบชื่อคอลัมน์และจำนวนคอลัมน์ให้ถูกต้องตามตัวอย่างไฟล์ excel
                <a href="../../../../docs/ตัวอย่างข้อมูลพัสดุที่จะนำเข้าระบบพัสดุ_UAT.xlsx" class=" underline underline-offset-2"> (download ตัวอย่างไฟล์รายการพัสดุ)</a>
            </p>
