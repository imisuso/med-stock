<template>
          <div 
                class="min-w-screen h-screen animated fadeIn faster  fixed  left-0 top-0 flex justify-center items-center inset-0 z-50 outline-hidden focus:outline-hidden bg-no-repeat bg-center bg-cover"  
                id="modal-id">
            ...
            <div class="">
                ...
                <div class="p-3  mt-2 text-center space-x-4 md:block">
                    <button 
                        class="mb-2 md:mb-0 bg-green-600 px-5 py-2 text-sm shadow-xs font-medium tracking-wider border text-white rounded-full hover:shadow-lg hover:bg-green-400"
...
export default {
    props: {
        confirm_item_name:String,
        confirm_item_date:String,
        confirm_item_count:String,
    },
    data() {
        return {
           // confirm_checkout: 0,
