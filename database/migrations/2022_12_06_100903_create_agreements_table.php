    ...
    public function up()
    {
        ...
        $agreement->contents = [
            'detail' => ['หน่วยเวชสารสนเทศ ภาควิชาอายุรศาสตร์ คณะแพทยศาสตร์ศิริราชพยาบาล มหาวิทยาลัยมหิดล มีการจัดเก็บรวบรวมข้อมูลส่วนบุคคลของท่าน โดยมีรายละเอียด ดังนี้',
                         '1.ข้อมูลส่วนบุคคลที่จัดเก็บ คือ ชื่อ-นามสกุล รหัสประจำตัวพนักงาน (SAPID)',
                         '2.ข้อมูลส่วนบุคคลที่จัดเก็บมีการกำหนดสิทธิ์การเข้าถึง ให้สำหรับผู้ปฏิบัติงานที่เกี่ยวข้องโดยตรงเท่านั้น',
                         '3.วัตถุประสงค์ในการรวบรวม จัดเก็บ และใช้งานข้อมูล เพื่อให้หน่วยงานผู้พัฒนาระบบสามารถนำไปวิเคราะห์ ปรับปรุงและพัฒนาระบบต่อไป',
                        ],
        ];
        $agreement->save();
